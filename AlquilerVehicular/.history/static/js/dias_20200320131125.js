    ...
    $.ajax({
        ...
        success: function(data, textStatus, jqXHR) {
            ...
            $.each(data, function(i, item) {
                html += '<option value="' + item.costId + '" >' + item.option + '  :  ' + item.typeVehicle + ' : $ ' + item.values + '</option>';

                opt += '<option value="' + item.costId + '" >' + item.option + '  :  ' + item.typeVehicle + ' : $ ' + item.values + '</option>';
            });
